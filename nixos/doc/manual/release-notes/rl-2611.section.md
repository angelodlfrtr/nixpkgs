...
- [Outline VPN client](https://getoutline.org/), a capability wrapper for the `outlinevpn-client` package, the desktop client for Outline VPN servers. Available as [programs.outlinevpn-client](#opt-programs.outlinevpn-client.enable).
